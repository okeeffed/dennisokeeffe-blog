...
That question has **_easily_** become the most common to come through my inbox. A request so common and emphatic that I can feel their energy oozing through the screen on my end. There is nothing inherently wrong about this curiosity. I would be surprised if you _hadn't_ asked the big questions somewhere along your development journey.
...
There are an unruly number of listicles that push unrealistic narratives, but today feels like the appropriate time to respond to those who asked the question with an authentic contribution that (hopefully) does not become another unhealthy statistic.
...
![The Dunning-Kruger Effect - image courtesy of Wikipedia](../assets/2020-08-08-dunning-kruger.png)

Looking at the image to illustrate the Dunning-Kruger effect, it has a "double peak" of sorts. The first when we are overconfident, the latter when I confident grows with experience and an appreciation for the vastness of a particular area.
...
1. Rushing through things you do not truly understand is more costly to your than spending the correct amount for a true understanding up-front.
...
This too is true of programming. Your first course may have been on Object-Oriented Programming, and understanding the "modelling of a vehicle interface" may have seemed like a bizarre first stop, but as you begin to learn more about the programming ecosystem, the more the puzzle begins to unravel itself and the applications become known. The more you begin to see th bigger picture, the more you can draw the connections, strengthen and even speed up your learning. Here are some trivial examples:
...
- Understanding how caches work on a fundamental level in computer can reveal how they operate for datastores and edge distribution fronts.

**The more you reveal of the puzzle, the easier it becomes to solve.**

As you learn, ask yourself this as your learn, _"How does this fit into the greater picture of things?"_ If you can see and appreciate how what you are learning will fit into the broader scheme, you can plan accordingly and connect the dots to strengthen your learning.
...
The title leading to this tip is a bit strong, but hear me out: **you will come across fascinating things to learn everyday in this career.** For those energetic and willing to learn, you will be easily tempted to move onto something exciting when it reveals itself.
...
The 10:1 ratio is not a hard and fast rule, but the gist of it is this: **spend more of your time generating output than taking in input.**
...
> Note: I know a physical learning of something to muscle memory may not be the most applicable analogy, but that is the one I always tell myself personally when spending too much time in "input" mode.

So how did I come up with the ten hours of work to one hour of input? That was an arbitrary figure set by myself. Most days I work up to ten hours and I am not always taking in input (depends on what I am working on), so those numbers for me generally make that up. The idea is more that you should be spending more time applying what you learn than the time you spending learning it from consumption.

## Use It Or Lose It — Memory Is Fallible

This point is an reiteration of the previous two: understand that we do not have perfect memory and not everything is stored.
...
As an personal example, I no longer work exclusively with iOS nor Kubernetes, but they were two areas I spent a significant amount of time investing in and learning for previous jobs. My way around this was to build a package management system at home so that I could quickly stand up projects for the house or hobbies that still keep me in touch with these technologies without having to dredge through to tedious groundwork to get these things up and running.
...
One of the trickier areas for time management: how do you get something day in the time you hav allocated? Have you ever spent time for an essay where you dilly-dallied and got nothing done? Maybe you always wanted to build a weekend project but kept putting it off?

Here is are two axioms of productivity: **Action begets action and doing builds motivation.**

The best way you can be effective with your time that you've allotted to learning or build a project is to do whatever it takes to start working.
...
Being at your best also means taking time to understand how your work best. This is different for everyone.
...
> I say this is easier said than done as I know there are many out there who are required to be "experts" in their area, particularly when working with clients. I'm not sure on the exact answer for this, but open-honesty and acceptance of yourself comes to mind. If I've had clients or interviewers ask questions that I don't understand, I level with them and tell them how I would try to find the answer. If they don't accept it, their loss - not yours.

If you operate with the mindset that the world is vast, there is always more to learn and curiousity becomes your driver, then with you will reach at times reach that rare nirvana of acceptance.
...
To be great at time management means to also be great at time delegation. Find ways to embrace the unknown and let it be a source of awe and inspiration, not one of degradation.

## Perseverance and the Now: A Tale of Two Developers

If there is one strikingly obvious thing that has come from this article, it is this: **not everything can be achieved right now**. The journey into an field requires persistence, perseverance and a healthy long-term commitment.

This isn't to say you need X years before things can be achieved. In reality, it is the opposite. It is incredible how much you can learn in an area if you invest your time wisely, focus in and create. If you've ever known someone to pick up and instrument and be incredibly proficient after a year, then you know that things can be achieved in short time-frames if you know your purpose and what you need to learn to achieve it.
